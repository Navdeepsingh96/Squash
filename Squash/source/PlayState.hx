...
class PlayState extends FlxState
{
	...
	override public function create():Void
	{
		...
		// background.color= 0x008080;
		background.loadGraphic(AssetPaths.background__jpg);
		add(background);


		scoreText=new FlxText(0,0, FlxG.width, "Blue|Red");
		scoreText.setFormat(null,36, FlxColor.LIME,"center");
		add(scoreText);
		...
		topwall.makeGraphic(FlxG.width,2,FlxColor.MAGENTA);//width, height, color
